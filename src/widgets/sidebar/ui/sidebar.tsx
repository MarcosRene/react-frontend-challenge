...
export function Sidebar() {
  ...
  return (
    <Collapsible.Root className="fixed left-0 right-0 top-0 z-20 flex flex-col gap-6 border-b border-border bg-background p-4 data-[state=open]:bottom-0 lg:right-auto lg:w-72 lg:border-r lg:px-5 lg:py-8 lg:data-[state=closed]:bottom-0">
